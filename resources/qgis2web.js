...
map.getView().fit([11854602.068868, -669514.059928, 11887264.913235, -648744.267628], map.getSize());
...
map.on("rendercomplete", function(evt) {
    if (!attributionComplete) {
        ...
        qgis2webAttribution.innerHTML = '<a href="https://drive.google.com/drive/folders/1ahGMP67DzM5qGT6jFM_9dZCVs8J0KCKj?usp=sharing"><div><h2>  DAFTAR PETA  </div></h2></a> &middot; ';
        var olAttribution = document.createElement('li');
        olAttribution.innerHTML = '<a href="https://drive.google.com/drive/folders/19vAiuPE5GIrWO93TePSIiUo2QFYLvVCc?usp=sharing">DATASET</a> &middot; ';
